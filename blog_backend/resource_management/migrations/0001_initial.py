...
class Migration(migrations.Migration):
    ...
    operations = [
            ...
            fields=[
                (
                    ...
                    models.OneToOneField(
                        ...
                        serialize=False,
                        to="resource_management.article",
                    ),
                ),
        ...
        migrations.AddIndex(
            model_name="image",
            index=models.Index(
                fields=["article", "alias"], name="idx_image_resolution_group"
            ),
        ),
        migrations.AddIndex(
            model_name="image",
            index=models.Index(
                fields=["article", "alias", "resolution"], name="idx_image_identity"
            ),
        ),
        migrations.AddConstraint(
            model_name="articletag",
            constraint=models.UniqueConstraint(
                fields=("article", "tag"), name="identity"
            ),
        ),
    ]
